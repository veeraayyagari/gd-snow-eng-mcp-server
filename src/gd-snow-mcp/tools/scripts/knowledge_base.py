...
from src.gd-snow-mcp.auth.auth_manager import AuthManager
from src.gd-snow-mcp.utils.config import ServerConfig
...
class CreateCategoryParams(BaseModel):
    ...
    parent_table: Optional[str] = Field(None,
...
class CreateArticleParams(BaseModel):
    ...
    article_type: Optional[str] = Field("html",
